...
sunshield]({{ site.baseurl }}{% link installations/Temporary_battery_with_sunshield.md %}).

# Localisation

Location of the instrument is NOT logged by the instrument itself. Do at
least [handheld GPS unit
logging]({{ site.baseurl }}{% link installations/Handheld_GPS_position_logging.md %}). AND relative
