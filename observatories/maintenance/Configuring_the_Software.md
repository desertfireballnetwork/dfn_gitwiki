...
GUI]({{ site.baseurl }}{% link observatories/maintenance/Using_the_GUI_for_Regular_Maintenance.md %}), or using the
...
[here]({{ site.baseurl }}{% link network/Logging_in_locally_via_WiFi_or_Ethernet.md %}). This could
be a laptop/cable, or via wifi, using a tablet/phone. Start your
browser, and follow the instructions in the [Camera
GUI]({{ site.baseurl }}{% link observatories/maintenance/Using_the_GUI_for_Regular_Maintenance.md %}) page.
...
See [detailed description]({{ site.baseurl }}{% link observatories/Dfnstation.cfg.md %}), use a command
like
...
page]({{ site.baseurl }}{% link observatories/maintenance/Manual_Maintenance.md %}#checking-removable-hard-drives).
...
page]({{ site.baseurl }}{% link observatories/maintenance/Manual_Maintenance.md %}#checking-gps).