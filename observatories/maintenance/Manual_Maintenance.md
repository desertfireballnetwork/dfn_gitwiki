...
[connect to your
camera]({{ site.baseurl }}{% link network/Logging_in_locally_via_WiFi_or_Ethernet.md %}).

If you are unable to connect to the camera system [locally via the
network (ethernet or
WiFi)]({{ site.baseurl }}{% link network/Logging_in_locally_via_WiFi_or_Ethernet.md %}), or [remotely
over the VPN]({{ site.baseurl }}{% link network/Logging_in_remotely_over_the_network.md %}), you can
...
control test]({{ site.baseurl }}{% link observatories/maintenance/Configuring_the_Software.md %}#capture-control-test)
...
configuration]({{ site.baseurl }}{% link observatories/dfnsmall/DFNSMALL_observatories_BIOS_configuration.md %}) is
correct.
...
![DFNEXT_PCboard_above_custom_PCB.jpg]({{ site.baseurl }}/images/DFNEXT_PCboard_above_custom_PCB.jpg)
...
2.  If the DSLR needs replacing as well, remove the outer blower ducting
    ...
    order of these
    steps]({{ site.baseurl }}{% link installations/How_to_install_flanged_Samyang_lens_and_DSLR_to_the_DFNEXT_enclosure.md %})).
...
5.  Remove the DFNEXT camera custom electronics PCB - it is not bolted
    ...
    ![DFNEXT_custom_PCB_removed.jpg]({{ site.baseurl }}/images/DFNEXT_custom_PCB_removed.jpg)
6.  Unscrew the 4 small Phillips head bolts in the corners of the
    Commell PC board.
    ![DFNEXT_unscrew_PC_board.jpg]({{ site.baseurl }}/images/DFNEXT_unscrew_PC_board.jpg)
7.  Remove wires and connectors from the original PC board. Mind the
    polarity of power terminal.
    ![DFNEXT_where_to_insert_flat_screwdriver.jpg]({{ site.baseurl }}/images/DFNEXT_where_to_insert_flat_screwdriver.jpg)
...
10. If the replacement PC does not have this adhesive on the heat
    ...
    bolts.
    ![DFNEXT_replacement_PC_with_bare_heatspreader_and_thermal_adhesive.jpg]({{ site.baseurl }}/images/DFNEXT_replacement_PC_with_bare_heatspreader_and_thermal_adhesive.jpg)
    ![DFNEXT_stick_the_thermal_adhesive_writing_up.jpg]({{ site.baseurl }}/images/DFNEXT_stick_the_thermal_adhesive_writing_up.jpg)
...
![DFNEXT_replace_the_CMOS_batt_CR2035.jpg]({{ site.baseurl }}/images/DFNEXT_replace_the_CMOS_batt_CR2035.jpg)
...
new PC board is replaced or if in case of unexpected camera system
behaviour, make sure the [BIOS and HW jumpers
configuration]({{ site.baseurl }}{% link observatories/dfnext/DFNEXT_onservatories_BIOS_configuration.md %}) is
correct.
