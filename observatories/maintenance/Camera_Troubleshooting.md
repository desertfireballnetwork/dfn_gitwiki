...
- The embedded PC must boot successfully - [how to
  troubleshoot](#how-to-troubleshoot-pc-booting)
...
shown on the
photo![DFN_camera_power_cable.jpg]({{ site.baseurl }}/images/DFN_camera_power_cable.jpg). It is
...
There is a DC power cable connected to the bottom of the camera box - as
shown on the [photo]({{ site.baseurl }}/images/DFN_camera_power_cable.jpg). It is
the biggest connector, and it needs to be unscrewed before unplugging.
Once the power is disconnected, please wait for about 1 minute and then
connect it back, tightening it again. Shortly after re-connecting the
power, there should be a sound of a fan inside the box and a little
...
![File:Samyang lens 800.jpg]({{ site.baseurl }}/images/Samyang_lens_800.jpg)
*<a href="File:Samyang">File:Samyang</a> lens
800.jpg*
...
![File:Moon_diffraction_spikes.jpg]({{ site.baseurl }}/images/Moon_diffraction_spikes.jpg)
*<a
href="File:Moon_diffraction_spikes.jpg">File:Moon_diffraction_spikes.jpg</a>*
...
![Lens_connectors_tape.jpg]({{ site.baseurl }}/images/Lens_connectors_tape.jpg)

And apply it to the connectors:

![Lens_connectors_taped.jpg]({{ site.baseurl }}/images/Lens_connectors_taped.jpg)

Then there are extra DSLR settings that must be set in order for the
correct metadata to be reported in the images:

![Non_CPU_lens_menu.jpg]({{ site.baseurl }}/images/Non_CPU_lens_menu.jpg)

![Non_CPU_lens_settings.jpg]({{ site.baseurl }}/images/Non_CPU_lens_settings.jpg)

Finally, manually set the aperture to f/4 (somewhere in between f/3.5
and f/5.6):

![Manual_aperture_set_f_4.jpg]({{ site.baseurl }}/images/Manual_aperture_set_f_4.jpg)
