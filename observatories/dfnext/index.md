...
[DFNSMALL]({{ site.baseurl }}{% link observatories/dfnsmall/index.md %}) design. The primary objective of the
...
![DFNEXT_installed_in_Northam]({{ site.baseurl }}/images/Internals_of_DFNEXT_installed_in_Northam.jpg)
*Internals_of_DFNEXT_installed_in_Northam.jpg*

![DFNEXT_Internals.jpg]({{ site.baseurl }}/images/DFNEXT_Internals.jpg)
*DFNEXT_Internals.jpg*

![Dfnext_connectors.jpg]({{ site.baseurl }}/images/Dfnext_connectors.jpg)
*Dfnext_connectors.jpg*

![DFNEXT_PCB.jpg]({{ site.baseurl }}/images/DFNEXT_PCB.jpg)
*DFNEXT_PCB.jpg*
...
[DFNEXT Assembly]({{ site.baseurl }}{% link observatories/dfnext/DFNEXT_Assembly.md %}).

Here are instructions on [Mobile network - 3G/4G modem installation and
configuration]({{ site.baseurl }}{% link network/Mobile_network_-_3G,_4G.md %}).
