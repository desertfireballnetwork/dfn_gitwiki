---
title: "DFN Modem Installation (Green Card)"
parent: "DFNEXT"
...
![File:Green_converter_card_and_Sierra_MC8705_modem_module_next_to_it.jpg]({{ site.baseurl }}/images/Green_converter_card_and_Sierra_MC8705_modem_module_next_to_it.jpg)
*<a
href="File:Green_converter_card_and_Sierra_MC8705_modem_module_next_to_it.jpg">File:Green_converter_card_and_Sierra_MC8705_modem_module_next_to_it.jpg</a>*
...
![Green_converter_card_with_Sierra_MC8705_modem_module_in_slot.jpg]({{ site.baseurl }}/images/Green_converter_card_with_Sierra_MC8705_modem_module_in_slot.jpg)

Next step is to insert the SIM card. First open the slot door and slide
the SIM card into it.

![Green_converter_card_SIM_slot_open.jpg]({{ site.baseurl }}/images/Green_converter_card_SIM_slot_open.jpg)

Then shut the slot door with SIM card and lock it - see arrows on the
slot door.

![Green_converter_card_with_SIM_card_in_slot.jpg]({{ site.baseurl }}/images/Green_converter_card_with_SIM_card_in_slot.jpg)
...
The [Mobile network
configuration]({% link network/Mobile_network_configuration.md %}) in the
