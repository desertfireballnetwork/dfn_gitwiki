...
[DFNEXT Modem Installation]({{ site.baseurl }}{% link observatories/dfnext/DFNEXT_Modem_Installation.md %}) - Blue
PCB modem converter card

[DFN Modem Installation - Green
card]({{ site.baseurl }}{% link observatories/dfnext/DFN_Modem_Installation_-_Green_card.md %}) - Green PCB modem
converter card

### Mobile network modem configuration

[Mobile network configuration]({{ site.baseurl }}{% link network/Mobile_network_configuration.md %})
