...
address via
[DHCP](https://en.wikipedia.org/wiki/Dynamic_Host_Configuration_Protocol) and
...
Linux).
![Putty_config_for_local_login.png]({{ site.baseurl }}/images/Putty_config_for_local_login.png)
